/*! cornerstone - v0.10.3 - 2017-03-05T14:45:34.503Z| (c) 2016 Chris Hafey | https://github.com/chafey/cornerstone */

(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
	(factory((global.cornerstone = global.cornerstone || {})));
...
var lastRenderedImageId$1;
var lastRenderedViewport$1 = {};
...
function getLut$1(image, viewport, invalidated) {
    // if we have a cached lut and it has the right values, return it immediately
    if (image.lut !== undefined && image.lut.windowCenter === viewport.voi.windowCenter && image.lut.windowWidth === viewport.voi.windowWidth && lutMatches(image.lut.modalityLUT, viewport.modalityLUT) && lutMatches(image.lut.voiLUT, viewport.voiLUT) && image.lut.invert === viewport.invert && invalidated !== true) {
        return image.lut;
    }
...
function doesImageNeedToBeRendered$1(enabledElement, image) {
    if (image.imageId !== lastRenderedImageId$1 || lastRenderedViewport$1.windowCenter !== enabledElement.viewport.voi.windowCenter || lastRenderedViewport$1.windowWidth !== enabledElement.viewport.voi.windowWidth || lastRenderedViewport$1.invert !== enabledElement.viewport.invert || lastRenderedViewport$1.rotation !== enabledElement.viewport.rotation || lastRenderedViewport$1.hflip !== enabledElement.viewport.hflip || lastRenderedViewport$1.vflip !== enabledElement.viewport.vflip || lastRenderedViewport$1.modalityLUT !== enabledElement.viewport.modalityLUT || lastRenderedViewport$1.voiLUT !== enabledElement.viewport.voiLUT) {
        return true;
    }
...
function getRenderCanvas$1(enabledElement, image, invalidated) {
    // apply the lut to the stored pixel data onto the render canvas

    if (doesImageNeedToBeRendered$1(enabledElement, image) === false && invalidated !== true) {
    ...
    // get the lut to use
    var lut = getLut$1(image, enabledElement.viewport, invalidated);
...
function renderGrayscaleImage(enabledElement, invalidated) {
    ...
    var renderCanvas = getRenderCanvas$1(enabledElement, image, invalidated);

    // Draw the render canvas half the image size (because we set origin to the middle of the canvas above)
    context.drawImage(renderCanvas, 0, 0, image.width, image.height, 0, 0, image.width, image.height);

    lastRenderedImageId$1 = image.imageId;
    lastRenderedViewport$1.windowCenter = enabledElement.viewport.voi.windowCenter;
    lastRenderedViewport$1.windowWidth = enabledElement.viewport.voi.windowWidth;
    lastRenderedViewport$1.invert = enabledElement.viewport.invert;
    lastRenderedViewport$1.rotation = enabledElement.viewport.rotation;
    lastRenderedViewport$1.hflip = enabledElement.viewport.hflip;
    lastRenderedViewport$1.vflip = enabledElement.viewport.vflip;
    lastRenderedViewport$1.modalityLUT = enabledElement.viewport.modalityLUT;
    lastRenderedViewport$1.voiLUT = enabledElement.viewport.voiLUT;
}
 ...
 */
function resize(element, useFitToWindow) {
...
function purgeCacheIfNecessary() {
    ...
    while (cacheSizeInBytes > maximumSizeInBytes) {
        ...
        delete imageCache$1[lastCachedImage.imageId];
...
function putImagePromise(imageId, imagePromise) {
    ...
    if (imageCache$1.hasOwnProperty(imageId) === true) {
    ...
    imageCache$1[imageId] = cachedImage;
...
function getImagePromise(imageId) {
    ...
    var cachedImage = imageCache$1[imageId];
...
function changeImageIdCacheSize(imageId, newCacheSize) {
    var cacheEntry = imageCache$1[imageId];
    if (cacheEntry) {
...
var get = getMetaData; // api compatibility
...
var imageCache$$1 = {
  imageCache: imageCache$1, cachedImages: cachedImages, setMaximumSizeBytes: setMaximumSizeBytes, putImagePromise: putImagePromise,
  getImagePromise: getImagePromise, removeImagePromise: removeImagePromise, getCacheInfo: getCacheInfo, purgeCache: purgeCache,
  changeImageIdCacheSize: changeImageIdCacheSize
};
var metaData = { addProvider: addProvider, removeProvider: removeProvider, get: get };
...
exports.imageCache = imageCache$$1;
exports.metaData = metaData;
exports.drawImage = drawImage;
exports.generateLut = generateLut;
exports.generateLutNew = generateLutNew;
exports.getDefaultViewport = getDefaultViewport;
exports.requestAnimationFrame = requestAnimationFrame;
exports.storedPixelDataToCanvasImageData = storedPixelDataToCanvasImageData;
exports.storedColorPixelDataToCanvasImageData = storedColorPixelDataToCanvasImageData;
exports.addEventListener = addEventListener;
exports.dispatchEvent = dispatchEvent;
exports.canvasToPixel = canvasToPixel;
exports.disable = disable;
exports.displayImage = displayImage;
exports.draw = draw;
exports.drawInvalidated = drawInvalidated;
...
exports.getDefaultViewportForImage = getDefaultViewportForImage;
...
exports.invalidateImageId = invalidateImageId;
exports.pageToPixel = pageToPixel;
exports.pixelToCanvas = pixelToCanvas;
exports.reset = reset;
exports.resize = resize;
exports.setToPixelCoordinateSystem = setToPixelCoordinateSystem;
